module.exports = function(RED) {
    ...
    function LevelControl(config) {
        ...
        this.server.socket.on('ready', function() {
            ...
            node.server.socket.write(node.server.encapsulateCommand(cmd));
        });
        ...
        this.server.socket.on('data', function(data) {
            ...
            msg.payload = node.server.decapsulateCommand(data);
            node.send(msg);
        });
        ...
        this.on('input', function(msg) {
            ...
            this.server.socket.write(this.server.encapsulateCommand(cmd));
        });
    }
