module.exports = function(RED) {
    ...
    function SoundwebControl(config) {
        ...
        this.server.socket.on('ready', () => {
            ...
            this.server.sendCommand(subscribeId(this.cmd_id), this.address, Buffer.from([0, 0, 0, 0]));
        });
        ...
        this.on('input', (msg) => {
            if (msg.hasOwnProperty('address') && Buffer.isBuffer(msg.address)) {
                this.server.sendCommand(unsubscribeId(this.cmd_id), this.address, Buffer.from([0, 0, 0, 0]));
